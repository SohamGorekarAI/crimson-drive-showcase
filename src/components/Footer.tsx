      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-luxury-light-gray/70 max-w-md leading-relaxed">
              Crafting automotive excellence since 1985. We specialize in the
              world's finest luxury vehicles, providing unmatched service and
              expertise.
            </p>
          </div>
        ...
        <div className="border-t border-luxury-light-gray/10 mt-8 pt-8 text-center">
          <p className="text-luxury-light-gray/60">
            &copy; 2024 Luxury Auto. All rights reserved. | Built with
            excellence.
          </p>
        </div>
      </div>
