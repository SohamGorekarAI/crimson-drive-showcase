...
import { Search, Filter, Heart, Eye, ArrowRight, Star, Calendar, Gauge, Fuel } from 'lucide-react';
  ...
  const vehicles: Vehicle[] = [
    {
      ...
      features: ["AMG Performance Seats", "Carbon Fiber Package", "Night Package"],
      rating: 4.9
    },
    {
      id: 2,
    ...
    },
    {
      ...
      price: "$198,500",
      year: 2024,
      image: "https://images.unsplash.com/photo-1606016159991-d8bfa52ee522?w=800&h=600&fit=crop",
      category: "Sports Cars",
      mileage: "4,200 miles",
      fuelType: "Premium",
    ...
    },
    {
      ...
      features: ["Executive Lounge", "Sky Lounge Roof", "Bowers & Wilkins Audio"],
      rating: 4.7
    },
    {
      id: 8,
      ...
      features: ["Sport Design Package", "Porsche InnoDrive", "Burmester Audio"],
      rating: 4.9
    },
    {
      id: 9,
    ...
    },
    {
      ...
      features: ["AMG Performance Package", "Night Package", "Off-Road Package"],
      rating: 4.8
    },
    {
      id: 11,
    ...
    },
    {
      ...
      features: ["Sports Plus Package", "Carbon Fiber Package", "Bang & Olufsen"],
      rating: 4.8
    },
    {
      id: 15,
    ...
    },
    {
      ...
      features: ["M Competition Package", "Carbon Ceramic Brakes", "M Driver's Package"],
      rating: 4.8
    },
    {
      id: 18,
    ...
    },
    {
      ...
      features: ["Sport Hybrid SH-AWD", "Carbon Ceramic Brakes", "Track Package"],
      rating: 4.8
    },
    {
      id: 23,
      ...
      features: ["Z07 Performance Package", "Carbon Fiber Wheels", "Competition Seats"],
      rating: 4.9
    },
    {
      id: 24,
      ...
      features: ["AMG Performance Package", "Ceramic Brakes", "Burmester 3D Audio"],
      rating: 4.8
    },
    {
      id: 25,
    ...
    },
    {
      ...
      features: ["Aerodinamica Lamborghini Attiva", "Carbon Monocoque", "Track Package"],
      rating: 5.0
    },
    {
      id: 30,
      ...
      features: ["Assetto Fiorano Package", "Carbon Package", "Manettino eDrive"],
      rating: 5.0
    }
  ];

  const categories = ['All', 'Sports Cars', 'Luxury Sedans', 'Luxury SUVs', 'Grand Tourers', 'Electric Sports', 'Hybrid Sports', 'Performance Sedans', 'Supercars'];
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        >
          ...
          <p className="text-xl text-luxury-light-gray/70 max-w-3xl mx-auto">
            Explore our exclusive collection of the world's finest luxury vehicles, 
            meticulously curated for the most discerning automotive enthusiasts.
          </p>
        </motion.div>
        ...
        >
          <div className="relative flex-1">
            <Search className="absolute left-4 top-1/2 -translate-y-1/2 text-luxury-light-gray/60" size={20} />
            <Input
              type="text"
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="flex items-center text-luxury-light-gray/60">
                        <Star className="fill-current text-yellow-500 mr-1" size={16} />
            ...
            >
              ...
              <div className="p-8">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      <div className="text-center p-4 bg-luxury-black/30 rounded-lg">
                        ...
                        <div className="text-luxury-light-gray/60 text-sm">Power</div>
                      </div>
                      <div className="text-center p-4 bg-luxury-black/30 rounded-lg">
                        <div className="text-luxury-light-gray text-lg font-semibold mb-1">
                          {selectedVehicle.specs.acceleration}
                        </div>
                        <div className="text-luxury-light-gray/60 text-sm">0-60 mph</div>
                      </div>
                      <div className="text-center p-4 bg-luxury-black/30 rounded-lg">
                        <div className="text-luxury-light-gray text-lg font-semibold mb-1">
                          {selectedVehicle.specs.topSpeed}
                        </div>
                        <div className="text-luxury-light-gray/60 text-sm">Top Speed</div>
                      </div>
                      <div className="text-center p-4 bg-luxury-black/30 rounded-lg">
                        <div className="text-luxury-light-gray text-lg font-semibold mb-1">
                          {selectedVehicle.year}
                        </div>
                        <div className="text-luxury-light-gray/60 text-sm">Year</div>
                      </div>
                    </div>

                    <div className="mb-6">
                      <h4 className="text-xl font-semibold text-luxury-light-gray mb-3">Vehicle Details</h4>
                      <div className="grid grid-cols-2 gap-4 text-luxury-light-gray/70">
                        <div>
                          <span className="font-medium">Engine:</span> {selectedVehicle.specs.engine}
                        </div>
                        <div>
                          <span className="font-medium">Mileage:</span> {selectedVehicle.mileage}
                        </div>
                        <div>
                  ...
                  <div>
                    <h4 className="text-xl font-semibold text-luxury-light-gray mb-4">Premium Features</h4>
                    <div className="space-y-2 mb-8">
                      {selectedVehicle.features.map((feature, index) => (
                        <div key={index} className="flex items-center text-luxury-light-gray/70">
                    ...
                    <div className="space-y-4">
                      ...
                      <Button variant="outline" className="w-full bg-transparent border-luxury-dark-gray text-luxury-light-gray hover:bg-luxury-dark-gray">
                        Contact Specialist
                      </Button>
                    </div>
                  </div>
